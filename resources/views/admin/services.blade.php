    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-extrabold text-white tracking-tight">Portal <span class="text-emerald-600">Layanan</span></h1>
                    <p class="text-white/50 text-sm font-medium">Konfigurasi etalase jasa Teknologi Arindama Andra.</p>
                </div>
            </div>

            <button @click="openAddModal()" class="group bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-3 rounded-2xl font-bold shadow-lg shadow-emerald-600/30 transition-all flex items-center gap-3">
                        ...
                        <tr class="hover:bg-blue-50/50 transition-all group">
                            ...
                            <td class="p-6">
                                <div class="flex justify-center">
                                    <span class="w-12 h-12 flex items-center justify-center bg-emerald-600 text-white rounded-2xl shadow-lg shadow-emerald-500/20 group-hover:rotate-6 transition-transform">
                            ...
                            <td class="p-6">
                                ...
                                <p class="text-emerald-600 text-[10px] font-bold uppercase tracking-widest mt-2">Active Service</p>
                            </td>
                            <td class="p-6">
    ...
    <div x-show="openModal"
        ...
        <div @click.away="openModal = false" class="bg-white rounded-[2.5rem] w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div class="p-8 border-b flex justify-between items-center bg-slate-50/50">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 bg-emerald-600 rounded-2xl flex items-center justify-center text-white text-xl shadow-lg">
            ...
            <form :action="editMode ? '/admin/services/' + currentService.id : '{{ route('services.store') }}'"
                ...
                <div class="bg-emerald-50/50 p-6 rounded-3xl border border-emerald-100">
                    <label class="block text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                        ...
                        <template x-for="(feature, index) in features" :key="index">
                            <div class="flex gap-3 animate-fadeIn">
                                <input type="text" name="features[]" x-model="features[index]" placeholder="Contoh: Gratis Instalasi..."
                                    class="flex-1 bg-white border border-emerald-100 p-3 rounded-xl text-sm font-bold text-slate-700 outline-none focus:ring-2 focus:ring-emerald-500">
                    ...
                    <button type="button" @click="addFeature()"
                        class="mt-4 text-xs font-black text-emerald-600 hover:text-emerald-800 flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-emerald-100 transition-all uppercase tracking-widest">
                ...
                <div class="pt-2">
                    ...
                    <div class="flex items-center gap-6 p-4 bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200">
                        ...
                        <input type="file" name="image_path" class="text-xs text-slate-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-[10px] file:font-black file:uppercase file:bg-emerald-600 file:text-white hover:file:bg-emerald-700 transition-all">
                    </div>
                </div>
